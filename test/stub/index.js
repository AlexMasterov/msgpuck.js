...
const stub = {
  ...
  'uint64_safe_overflow': [
    type('9007199254740992', MAX_SAFE_INT_OVERFLOW, byte(0xcb, 0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)),
  ],
  ...
  'int64_safe_overflow': [
    type('-9007199254740992', MIN_SAFE_INT_OVERFLOW, byte(0xcb, 0xff, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)),
  ],
  'int64': global.BigInt ? [
