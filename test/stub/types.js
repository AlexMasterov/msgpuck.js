...
const types = {
  ...
  'int NaN cb': [
    { name: 'NaN', value: Number.MIN_SAFE_INTEGER - 1, bin: bytes(0xcb, 0x7f, 0xf8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00) },
  ],
  'uint Infinity cb': [
  ...
  //     bin: bytes(0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xe0, 0xff) },
  //   { name: 'max safe integer', value: BigInt(Number.MAX_SAFE_INTEGER),
  //     bin: bytes(0x06, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x1f, 0x00) },
  //   { name: 'min int64', value: -9223372036854775808n,
  //     bin: bytes(0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80) },
  //   { name: 'max int64', value: 9223372036854775807n,
  //     bin: bytes(0x06, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f) },
  // ],
  'str5 a0-bf': [
