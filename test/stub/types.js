...
const types = {
  ...
  'uint64': [
    ...
    type('overflow (9007199254740992)', MAX_SAFE_INT_OVERFLOW, byte(0xcb, 0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)),
  ],

  '-fixint': [
    type('min (-32)', -32, byte(0xe0)),
    type('max (-1)', -1, byte(0xff)),
  ],
  'int8': [
    type('min (-128)', -128, byte(0xd0, 0x80)),
    type('max (-33)', -33, byte(0xd0, 0xdf)),
  ],
  'int16': [
    type('min (-32768)', -32768, byte(0xd1, 0x80, 0x00)),
    type('max (-129)', -129, byte(0xd1, 0xff, 0x7f)),
  ],
  'int32': [
    type('min (-2147483648)', -2147483648, byte(0xd2, 0x80, 0x00, 0x00, 0x00)),
    type('max (-32769)', -32769, byte(0xd2, 0xff, 0xff, 0x7f, 0xff)),
  ],
  'int64': [
    type('max (-9007199254740991)', MIN_SAFE_INT, byte(0xd3, 0xff, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01)),
    type('overflow (-9007199254740992)', MIN_SAFE_INT_OVERFLOW, byte(0xcb, 0xff, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)),
  ],
